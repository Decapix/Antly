...
SPECE_CHOICES = [('Acamatus', 'Acamatus'), ('Acanthognathus', 'Acanthognathus'), ('Acanthomyops', 'Acanthomyops'),
                 ...
                 ('Notoncus', 'Notoncus'), ('Novomessor', 'Novomessor'), ('Odontomachus', 'Odontomachus'), ('Oecophylla', 'Oecophylla'),
                 ...
                 ('Platythyrea', 'Platythyrea'), ('Pogonomyrmex', 'Pogonomyrmex'), ('Polyergus', 'Polyergus'), ('Polyrhachis', 'Polyrhachis'), 
